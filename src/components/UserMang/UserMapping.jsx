...
//   return (
//     <div className="p-4 sm:p-6 max-w-full mx-auto bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen">
...
//         {/* Table Wrapper (scrollable for small screens) */}
